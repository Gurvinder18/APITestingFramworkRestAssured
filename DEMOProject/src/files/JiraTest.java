...
public class JiraTest {
	...
	public static void main(String[] args) {
		...
		//Remembers session details when session exists---------------------------------------------
		SessionFilter session=new SessionFilter();
		//Login Request------------------------------------------------------------------------------
		String response=given()
				.relaxedHTTPSValidation()//For bypassing https certification very imp---------------
		...
		//Parsing complex JSON and validation using TestNG------------------------------------------------
